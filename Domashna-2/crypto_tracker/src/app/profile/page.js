...
export default function ProfilePage() {
  ...
  const { favorites, loading: favLoading, toggleFavorite, refetch } = useFavorites();
  ...
  const handleRemoveFavorite = async (coin) => {
    const confirmed = window.confirm(`Remove ${coin.name || coin.symbol} from favorites?`);
    if (confirmed) {
          ...
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 font-medium">User Profile</p>
              </div>
            </Link>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="text-right">
              <div className="bg-slate-700/50 rounded-lg px-6 py-4">
                <div className="text-3xl font-bold text-cyan-400">{favorites.length}</div>
          ...
          <div className="flex border-b border-slate-700">
            ...
            >
              <div className="flex items-center justify-center gap-2">
                <svg className="w-5 h-5" fill={activeTab === 'favorites' ? 'currentColor' : 'none'} stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                {favLoading ? (
                  ...
                  <div className="text-center py-16">
                    ...
                    <h3 className="text-2xl font-bold mb-2">No Favorite Coins Yet</h3>
                    <p className="text-slate-400 mb-6">Start adding coins to your favorites to track them here!</p>
                    <Link
                      href="/"
                      ...
                      >
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <h3 className="font-bold text-lg">{favorite.coin_name || favorite.coin_symbol}</h3>
                              <p className="text-cyan-400 font-mono text-sm">{favorite.coin_symbol}</p>
                            </div>
                          </div>
                          <button
                            onClick={() => handleRemoveFavorite({ symbol: favorite.coin_symbol, name: favorite.coin_name })}
